...
<a href="Contact">
<svg viewBox="0 0 230 160" width="200" height="160" >
  <circle cx="80" cy="80" r="50" />
  <g transform=" matrix(0.866, -0.5, 0.25, 0.433, 80, 80)">
    <path d="M 0,70 A 65,70 0 0,0 65,0 5,5 0 0,1 75,0 75,70 0 0,1 0,70Z" fill="#888">
      <animateTransform attributeName="transform" type="rotate" from="360 0 0" to="0 0 0" dur="1s" repeatCount="indefinite" />
    </path>
  </g>
  <g transform=" matrix(0.6, -0.3, 0.1, 0.5, 160, 160)">
    <path d="M 1,70 A 65,100 0 0,80 65,0 5,5 0 0,1 75,0 34,70 0 13,1 0,70Z" fill="#FFF7">
      <animateTransform attributeName="transform2" type="rotate" from="260 100 0" to="100 0 360" dur="1s" repeatCount="indefinite" />
    </path>
  </g>
  <path d="M 50,0 A 50,50 0 0,0 -50,0Z" transform="matrix(0.866, -0.5, 0.5, 0.866, 80, 80)" />
  <path d="M 100,0 A 100,100 0 0,0 50,0Z" transform=" matrix(0.6, -0.3, 0.1, 0.5, 160, 160)" />
  

<svg width="350" height="350" viewBox="120 40 200 350">
  <path id="myPath" fill="none" stroke="#888888"  stroke-miterlimit="10" d="M91.4,104.2c3.2-3.4,18.4-0.6,23.4-0.6c5.7,0.1,10.8,0.9,16.3,2.3
  ...
  <text>
    <textpath xlink:href="#myPath" fill="gray" >
      CAKEEMP MAXIME GREGOIRE
    </textpath>
  </text>
</svg>
</svg>
